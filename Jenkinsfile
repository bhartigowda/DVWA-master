        ...
        stage('IO - Workflow') {
            steps {
                ...
                synopsysIO(connectors: [
                    ...
                    blackduck(configName: 'poc-bd', projectName: 'dvwa-test', projectVersion: '1.0'),
                    jira(assignee: 'karn@synopsys.com', configName: 'poc-jira', issueQuery: 'resolution=Unresolved AND labels in (Security, Defect)', projectKey: 'DVWAT'), 
